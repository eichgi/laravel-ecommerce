                                            ...
                                            <tr>
                                                <td valign="top" class="bodyContent">
                                                    <div mc:edit="std_content00">
                                                        <h1 class="h1">Recibo de tu pago en productos facilito</h1>
                                                        ...
                                                        <tr>
                                                            <td valign="middle" class="templateButtonContent">
                                                                <div mc:edit="std_content02">
                                                                    <a href="{{url('/compras/'.$order->shoppingCartID())}}" target="_blank">
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <div mc:edit="std_footer">
                                                        <em>Copyright &copy; 2017 CódigoFacilito, Todos los derechos reservados.</em>
                                                        <br/>
