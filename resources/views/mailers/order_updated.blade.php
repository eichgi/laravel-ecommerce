...
<head>
    ...
    <style type="text/css">
        ...
        *
        ...
        Set the styling for your email's button. Choose a style that draws attention.
                            */
        .templateButton, .templateButton a:link, .templateButton a:visited, /* Yahoo! Mail Override */
                                            ...
                                            <tr>
                                                <td valign="top" class="bodyContent">
                                                    <div mc:edit="std_content00">
                                                        ...
                                                        Hemos actualizado el status de tu pedido:
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <th scope="col" valign="top" width="25%"
                                                                class="dataTableHeading" mc:edit="data_table_heading00">
                                                                INFORMACIÓN
                                                            </th>
                                                            <th scope="col" valign="top" width="25%"
                                                                class="dataTableHeading" mc:edit="data_table_heading01">
                                                                ESTADO
                                                            </th>
                                                        </tr>
                                                        <tr mc:repeatable>
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="bodyContent">
                                                                <div mc:edit="std_content00">
                                                                    Si hay algun dato erroneo comunicarse a ayuda@soporte.com
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td valign="middle" class="templateButtonContent">
                                                                <div mc:edit="std_content02">
                                                                    <a href="{{url('/compras/'.$order->shoppingCartID())}}"
                                                                       target="_blank">
                                                                        Ver información de pedido</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <div mc:edit="std_footer">
                                                        <em>Copyright &copy; 2017 CódigoFacilito, Todos los derechos
                                                            reservados.</em>
                                                        <br/>
                                                        <strong>Nuestra dirección de correo es:</strong>
                                                        <br/>
                                                        contacto@ayudasoporte.com
                                                    </div>
                                                </td>
                                            </tr>
                                            {{--<tr>
                                                <td valign="middle" id="utility">
                                                    <div mc:edit="std_utility">
                                                        &nbsp;<a href="*|ARCHIVE|*" target="_blank">view this in your
                                                            browser</a> | <a href="*|UNSUB|*">unsubscribe from this
                                                            list</a> | <a href="*|UPDATE_PROFILE|*">update subscription
                                                            preferences</a>&nbsp;
                                                    </div>
                                                </td>
                                            </tr>--}}
